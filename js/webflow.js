...
Webflow.require('ix').init([
  {"slug":"hide-on-load","name":"hide_on_load","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"open-filter-add","name":"open_filter_add","value":{"style":{},"triggers":[{"type":"click","selector":".u-block-filter-add","stepsA":[{"display":"block","height":"0px"},{"display":"block","height":"auto","wait":600,"transition":"height 500ms linear 0ms"}],"stepsB":[{"display":"block","height":"0px","wait":600,"transition":"height 500ms linear 0ms"},{"display":"none"}]}]}},
  {"slug":"login","name":"login","value":{"style":{},"triggers":[{"type":"click","selector":".u-nav-link","stepsA":[{"display":"inline-block"}],"stepsB":[]},{"type":"click","selector":".u-nav-login","stepsA":[{"display":"none"}],"stepsB":[]}]}},
  {"slug":"bookin","name":"bookin","value":{"style":{},"triggers":[{"type":"click","stepsA":[{"display":"none"}],"stepsB":[]},{"type":"click","selector":".u-btn-booked","stepsA":[{"display":"block"}],"stepsB":[]}]}}
]);
